...
namespace EasyAlipay\OpenLife\Message\Model;

/* *
 * 功能：alipay.open.public.message.total.send (群发消息)业务参数封装,相见：https://docs.open.alipay.com/api_6/alipay.open.public.message.total.send
 */
