...
namespace EasyAlipay\OpenLife\Template;

use EasyAlipay\Kernel\Support;
use EasyAlipay\Kernel\AopClient;
use EasyAlipay\Kernel\AopRequest;
use EasyAlipay\Kernel\Config;
use EasyAlipay\OpenLife\Model\AlipayOpenPublicTemplateMessageGetContentBuilder;
use EasyAlipay\OpenLife\Model\AlipayOpenPublicTemplateMessageIndustryModifyContentBuilder;
